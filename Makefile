...
.PHONY : clean
clean :
	rm -f chemlab parser.ml parser.mli scanner.ml *.cmo *.cmi *.class com/graphics/*.class ChemGRAPH.java files_test/*.out files_demo/*.out test* demo*
